...
public class methodsLib : MonoBehaviour {
    ...
    public static string blokCoordinate(string temp, int Xoffset, int Yoffset)
    {
        string newstring = "";
    ...
    public static string findName(coordinate c)
    {
        string newstring = "";
        int tempX = c.getX();
        int tempY = c.getY();
    ...
    public static coordinate blokCoordinate(char[] temp)
    {
    ...
    public static coordinate blokCoordinate(string temp)
    {
        int tempX = (temp[5] - '0') * 10 + (temp[6] - '0');
        int tempY = (temp[9] - '0') * 10 + (temp[10] - '0');
        return new coordinate(tempX, tempY);
